...
import 'package:primeiro_flutter/data/datasources/database.dart'; // Importação adicionada
...
class DoseEventCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final time = DateFormat('HH:mm').format(combinedData.doseEvent.scheduledTime);
